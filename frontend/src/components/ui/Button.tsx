...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', loading = false, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      ...
      secondary: 'bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 focus:ring-primary/20',
      outline: 'border border-primary text-primary hover:bg-primary hover:text-white focus:ring-primary/20',
      ghost: 'text-gray-700 hover:bg-gray-100 focus:ring-primary/20',
    }
